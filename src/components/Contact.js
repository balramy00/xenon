    ...
    <div class="bg-warm-gray-50">
      <div class="py-24 lg:py-32">
        <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
          ...
          <p class="mt-6 text-xl text-warm-gray-500 max-w-3xl">Greeting, Here you can found how to contact us for any kind of service you can reach us 24/7. We are always here to help you.</p>
        </div>
      </div>
    </div>
